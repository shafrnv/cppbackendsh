...
Dog& GameSession::AddDog(std::string name, const Road& road) {
...
Player& Players::AddPlayer(std::string dog, GameSession* session) {
    ...
    Player player_(*session, session->AddDog(dog, road), token);
